...
我是**湖南科技大学计算机科学专业大三学生**，对人工智能充满热情，目前主要专注于**AI Agent领域的学习研究与开发**
...
> 计划学习：TypeScript · Rust（C/C++ 和 Java 按需深究）
...
> 学习中：LangGraph · RAG · Multi-Agent

---

### Web 技术

> 计划学习：FastAPI · WebSocket/SSE · React · Node.js
...
- **AI Agent 工程**：研究 LangGraph 图结构编排、RAG 检索增强、Multi-Agent 协作架构
